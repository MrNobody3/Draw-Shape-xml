	...
	public MainFrame(){
                ...
                readXml.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try {
                            ...
                            xmlReader.read("D:\\exemple.xml");
                            paintPanel.setFigure(xmlReader.getFigure());
		...
		convertToXmlBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					xmlWriter.convert("exemple.xml", paintPanel.getFigure());
					JOptionPane.showMessageDialog(null,"fichier xml cr�e correctement","OK", JOptionPane.INFORMATION_MESSAGE);
